...
import org.ict.model.wot.security.iface.PoPSecuritySchemeIf;
...
public class PoPSecurityScheme extends SecurityScheme implements PoPSecuritySchemeIf {
  ...
  public PoPSecurityScheme() {
    super(null, PoPSecurityScheme.class.getName(), SecuritySchemaType.Pop.getType(), null, null,
        null, null);
  }

  @Builder
  public PoPSecurityScheme(SecuritySchemaType scheme, List<String> atType, String description,
      Map<String, String> descriptions, URI proxy, URI authorization, Alg alg, Format format, In in,
      String name) {
    super(null, PoPSecurityScheme.class.getName(), scheme.getType(), atType, description,
        descriptions, proxy);
