 ...
 * @author F. Kohlmorgen
 */
@RDFBean("https://www.w3.org/2019/wot/json-schema#IntegerSchema")
public interface IntegerSchemaIf extends DataSchemaIf{
	@RDF("https://www.w3.org/2019/wot/json-schema#minimum")
	Number getMinimum();

	@RDF("https://www.w3.org/2019/wot/json-schema#maximum")
	Number getMaximum();
