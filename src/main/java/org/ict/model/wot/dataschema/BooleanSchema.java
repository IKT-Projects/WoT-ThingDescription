...
import static org.ict.model.wot.constant.DataSchemaType.BooleanSchema;
...
public class BooleanSchema extends DataSchema implements BooleanSchemaIf {
  private transient DataSchema modified;
  @SerializedName("schema:dateModified")
  private Modified jsonModified;

  public BooleanSchema() {
    super(null, null, BooleanSchema.class.getName(), null, null, null, null, null, null, null, null,
        null, null, null, null, null);
  }

  @Builder
  public BooleanSchema(String id, List<URI> atType, String title, List<MultiLanguage> titles,
    ...
    super(id, null, BooleanSchema.class.getName(), atType, title, titles, description, descriptions,
        BooleanSchema.type(), constant, unit, oneOf, enumeration, readOnly, writeOnly, format);
