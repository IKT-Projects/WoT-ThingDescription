 ...
 */
package org.ict.model.wot.add.hardware;

import java.net.URI;
import java.util.ArrayList;
import java.util.List;
import org.ict.model.wot.add.hardware.iface.HardwareIf;
...
@Data
@Builder
public class Hardware implements HardwareIf {
  @NonNull
  private URI id;
  @SerializedName("@type")
  ...
  private Link manufacturerLink;
  private String serialNumber;
  private String productId;
  private String deviceType;
  private String softwareVersion;
  private String hardwareVersion;
  private Link externalInformation;
